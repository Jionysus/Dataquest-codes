...
max_Lipid_Tot = food_info["Lipid_Tot_(g)"].max()
min_Lipid_Tot = food_info["Lipid_Tot_(g)"].min()
normalized_fat = (food_info["Lipid_Tot_(g)"] - min_Lipid_Tot) / (max_Lipid_Tot - min_Lipid_Tot)
